...
namespace PeluqueriaStar.App.consola
{
    class Program
    {
        ...
        private static IRepositorioAdministrador _repoadministrador = new ReposopitorioAdministrador(new Persistencia.AppContext());
        ...
        private static void AddAdmistrador()
        {
            ...
            _repoadministrador.AddAdmistrador(administrador);
